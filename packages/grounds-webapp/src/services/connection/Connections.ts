...
import { buildInjectedConnector } from "../wallet/MetamaskWallet"
import { buildNetworkConnector } from "../wallet/BrowserWallet"
import { buildWalletConnectConnector } from "../wallet/WalletConnectWallet"
import { buildGnosisSafeConnector } from "../wallet/GnosisWallet"
import { buildCoinbaseWalletConnector } from "../wallet/CoinbaseWallet"
import { CHAIN_INFO } from "../../utils/walletConstants"
...
export const PRIORITIZED_CONNECTORS: { [key in ConnectionType]: Connection | any } = {
