...
const getInfuraUrlFor = (network: string) => `https://${network}.infura.io/v3/4bf032f2d38a4ed6bb975b80d6340847`
const getAlchemyUrlFor = (network: string) =>`https://${network}.alchemyapi.io/v2/<apiKey>` 
